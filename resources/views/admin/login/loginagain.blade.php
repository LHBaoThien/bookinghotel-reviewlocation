		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<h2>Email And Password agian</h2>
					<form class="form-horizontal" action="messages.html" method="post">
						<fieldset>
							...
							<div class="input-prepend" title="Password">
								...
								<input class="input-large span10" name="password" id="password" type="password" placeholder="Password New"/>
							</div>
							<div class="clearfix"></div><div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="password" id="password" type="password" placeholder="Password Again"/>
							</div>
							<div class="clearfix"></div>
